...
EXPORT BOOL ANT_Init(UCHAR ucUSBDeviceNum, ULONG ulBaudrate, UCHAR ucPortType=PORT_TYPE_USB, UCHAR ucSerialFrameType=FRAMER_TYPE_BASIC);  //Initializes and opens USB connection to the module
